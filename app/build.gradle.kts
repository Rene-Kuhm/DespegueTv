...
android {
    ...
    defaultConfig {
        ...
        buildConfigField("String", "IMDB_EPISODE_RATINGS_API_BASE_URL", "\"${localProperties.getProperty("IMDB_EPISODE_RATINGS_API_BASE_URL", "")}\"")
    ...
    buildTypes {
        debug {
            ...
            buildConfigField("String", "IMDB_EPISODE_RATINGS_API_BASE_URL", "\"${devProperties.getProperty("IMDB_EPISODE_RATINGS_API_BASE_URL", "")}\"")

...
import com.despegue.tv.data.remote.api.AddonApi
import com.despegue.tv.data.remote.api.AniSkipApi
import com.despegue.tv.data.remote.api.AnimeSkipApi
import com.despegue.tv.data.remote.api.ArmApi
import com.despegue.tv.data.remote.api.DonationsApi
import com.despegue.tv.data.remote.api.GitHubReleaseApi
...
import com.despegue.tv.data.remote.api.SponsorsApi
import com.despegue.tv.data.remote.api.TmdbApi
import com.despegue.tv.data.remote.api.UniqueContributionsApi
...
import com.despegue.tv.core.network.IPv4FirstDns
import java.io.File
...
object NetworkModule {
        ...
        return OkHttpClient.Builder()
            ...
            .addInterceptor { chain ->
                ...
                val request = chain.request().newBuilder()
                    .header("User-Agent", "Despegue/$version")
                    .build()
    ...
    fun provideRetrofit(okHttpClient: OkHttpClient, moshi: Moshi): Retrofit =
        Retrofit.Builder()
            .baseUrl("https://placeholder.despegue.tv/")
            .client(okHttpClient)

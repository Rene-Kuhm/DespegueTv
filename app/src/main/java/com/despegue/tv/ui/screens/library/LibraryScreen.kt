package com.despegue.tv.ui.screens.library
...
import com.despegue.tv.domain.model.LibraryListTab
import com.despegue.tv.domain.model.LibrarySourceMode
import com.despegue.tv.domain.model.PosterShape
import com.despegue.tv.domain.model.TraktListPrivacy
import com.despegue.tv.ui.components.EmptyScreenState
import com.despegue.tv.ui.components.GridContentCard
import com.despegue.tv.ui.components.PosterCardDefaults
...
import com.despegue.tv.ui.util.formatAddonTypeLabel
import com.despegue.tv.ui.util.localizedGenreLabel
...
fun LibraryScreen(
        ...
        item(span = { GridItemSpan(maxLineSpan) }) {
            Row(
                ...
                Text(
                    ...
                    color = if (showBuiltInHeader) DespegueColors.TextPrimary else Color.Transparent,
                ...
                Text(
                    text = when {
                        ...
                        uiState.isDespegueAccount -> "DESPEGUE"
                        else -> stringResource(R.string.library_source_local)
                    },
                    style = MaterialTheme.typography.labelLarge,
                    color = if (showBuiltInHeader) DespegueColors.TextTertiary else Color.Transparent,
    ...
    if (!transientMessage.isNullOrBlank()) {
        Box(
            ...
            Text(
                ...
                modifier = Modifier
                    .padding(top = 24.dp)
                    .background(DespegueColors.BackgroundElevated, RoundedCornerShape(10.dp))
    ...
    com.despegue.tv.ui.components.posteroptions.PosterOptionsHost(
            ...
            Column(
                ...
                Row(
                    ...
                    Icon(
                        ...
                        tint = if (isFocused) DespegueColors.FocusRing else DespegueColors.TextSecondary
                    )
                }
            }
        }
        ...
        DropdownMenu(
            ...
            options.forEach { option ->
                ...
                val itemTextColor = when {
                    isOptionFocused -> DespegueColors.OnSecondary
                    isSelected -> DespegueColors.TextPrimary
                    else -> DespegueColors.TextPrimary
                }
                val itemBackgroundColor = when {
                    isOptionFocused -> DespegueColors.Secondary
                    isSelected -> DespegueColors.FocusBackground
                ...
                DropdownMenuItem(
                    ...
                    colors = MenuDefaults.itemColors(
                        ...
                        disabledTextColor = DespegueColors.TextDisabled
                    )
                )
            }
        }
...
private fun ManageListsDialog(
    ...
    Dialog(onDismissRequest = onDismiss) {
        Box(
            modifier = Modifier
                .width(620.dp)
                .background(DespegueColors.BackgroundElevated, RoundedCornerShape(16.dp))
                .padding(24.dp)
        ) {
            Column(verticalArrangement = Arrangement.spacedBy(14.dp)) {
                ...
                if (personalTabs.isEmpty()) {
                    Text(
                        ...
                        style = MaterialTheme.typography.bodyMedium,
                        color = DespegueTheme.extendedColors.textSecondary
                    )
                } else {
                    LazyColumn(
                        modifier = Modifier
                        ...
                        items(personalTabs, key = { it.key }) { tab ->
                            ...
                            Button(
                                ...
                                colors = ButtonDefaults.colors(
                                    containerColor = if (selected) DespegueColors.FocusBackground else DespegueColors.BackgroundCard,
                                    contentColor = DespegueColors.TextPrimary
                                )
                            ) {
                                Text(
    ...
    DespegueDialog(
        ...
        androidx.compose.material3.OutlinedTextField(
            ...
            colors = androidx.compose.material3.OutlinedTextFieldDefaults.colors(
                focusedTextColor = DespegueColors.TextPrimary,
                unfocusedTextColor = DespegueColors.TextPrimary,
                focusedContainerColor = DespegueColors.BackgroundCard,
                unfocusedContainerColor = DespegueColors.BackgroundCard,
                focusedBorderColor = DespegueColors.FocusRing,
                unfocusedBorderColor = DespegueColors.Border,
                focusedLabelColor = DespegueColors.TextSecondary,
                unfocusedLabelColor = DespegueColors.TextTertiary,
                cursorColor = DespegueColors.FocusRing
            )
        )

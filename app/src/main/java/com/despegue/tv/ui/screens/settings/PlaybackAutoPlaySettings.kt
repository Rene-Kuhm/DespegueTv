                    ...
                    Card(
                        ...
                        Row(
                            ...
                            Column(modifier = Modifier.weight(1f)) {
                                Text(
                                    text = title,
                                    color = if (isSelected || isFocused) DespegueColors.Primary else DespegueColors.TextPrimary,
                                    style = MaterialTheme.typography.bodyLarge
                                )
                                Spacer(modifier = Modifier.height(4.dp))
                                Text(
    ...
    DespegueDialog(
        ...
        Column(
            ...
            Card(
                ...
                colors = CardDefaults.colors(
                    containerColor = if (selected.isEmpty()) DespegueColors.FocusBackground else DespegueColors.BackgroundCard,
                    focusedContainerColor = DespegueColors.FocusBackground
                ),
                shape = CardDefaults.shape(shape = androidx.compose.foundation.shape.RoundedCornerShape(10.dp)),
                scale = CardDefaults.scale(focusedScale = 1f)
                ...
                Row(
                    ...
                    Text(
                        text = allLabel,
                        color = if (selected.isEmpty()) DespegueColors.Primary else DespegueColors.TextPrimary,
                        style = MaterialTheme.typography.bodyLarge,
                        modifier = Modifier.weight(1f)
                    )
                    if (selected.isEmpty()) {
                ...
                Card(
                    ...
                    Box(modifier = Modifier.padding(horizontal = 14.dp, vertical = 12.dp)) {
                        BasicTextField(
                            ...
                            textStyle = MaterialTheme.typography.bodyMedium.copy(color = DespegueColors.TextPrimary),
                            cursorBrush = SolidColor(if (isInputFocused) DespegueColors.Primary else Color.Transparent),

package com.despegue.tv.ui.navigation
...
import com.despegue.tv.ui.screens.CatalogSeeAllScreen
import com.despegue.tv.ui.screens.LayoutSelectionScreen
import com.despegue.tv.ui.screens.detail.MetaDetailsScreen
import com.despegue.tv.ui.screens.home.HomeScreen
import com.despegue.tv.ui.screens.addon.AddonManagerScreen
import com.despegue.tv.ui.screens.addon.CatalogOrderScreen
import com.despegue.tv.ui.screens.library.LibraryScreen
import com.despegue.tv.ui.screens.player.PlayerScreen
import com.despegue.tv.ui.screens.plugin.PluginScreen
import com.despegue.tv.ui.screens.search.DiscoverScreen
import com.despegue.tv.ui.screens.search.SearchScreen
import com.despegue.tv.ui.screens.settings.AboutScreen
import com.despegue.tv.ui.screens.settings.LayoutSettingsScreen
import com.despegue.tv.ui.screens.settings.PlaybackSettingsScreen
import com.despegue.tv.ui.screens.settings.SettingsScreen
import com.despegue.tv.ui.screens.settings.SupportersContributorsScreen
import com.despegue.tv.ui.screens.settings.ThemeSettingsScreen
import com.despegue.tv.ui.screens.settings.TraktScreen
import com.despegue.tv.ui.screens.settings.TmdbSettingsScreen
import com.despegue.tv.ui.screens.stream.StreamScreen
import com.despegue.tv.ui.screens.home.ContinueWatchingItem
import com.despegue.tv.ui.screens.account.AuthSignInScreen
import com.despegue.tv.ui.screens.account.AuthQrSignInScreen
import com.despegue.tv.ui.screens.cast.CastDetailScreen
import com.despegue.tv.ui.screens.profile.ProfileSelectionMode
import com.despegue.tv.ui.screens.profile.ProfileSelectionScreen
import com.despegue.tv.ui.screens.tmdb.TmdbEntityBrowseScreen
import com.despegue.tv.ui.screens.home.HeroBackdropState
...
fun DespegueNavHost(
    ...
    NavHost(
        ...
        composable(Screen.Search.route) { backStackEntry ->
            val searchViewModel: com.despegue.tv.ui.screens.search.SearchViewModel =
        ...
        composable(Screen.Collections.route) {
            com.despegue.tv.ui.screens.collection.CollectionManagementScreen(
        ...
        composable(
            ...
            com.despegue.tv.ui.screens.collection.CollectionEditorScreen(
                onBack = { navController.popBackStack() }
            )
        }
        ...
        composable(
            ...
            com.despegue.tv.ui.screens.collection.FolderDetailScreen(
                onNavigateToDetail = { itemId, itemType, addonBaseUrl ->
                    navController.navigate(Screen.Detail.createRoute(itemId, itemType, addonBaseUrl))
                },
                onBack = { navController.popBackStack() }
        ...
        composable(
            ...
            val searchViewModel: com.despegue.tv.ui.screens.search.SearchViewModel? =
                if (searchBackStackEntry != null) {
                    androidx.hilt.navigation.compose.hiltViewModel<com.despegue.tv.ui.screens.search.SearchViewModel>(searchBackStackEntry)
                } else null

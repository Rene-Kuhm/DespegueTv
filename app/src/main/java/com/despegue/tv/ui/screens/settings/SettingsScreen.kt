...
import com.despegue.tv.ui.screens.plugin.PluginScreenContent
...
private fun PluginsSettingsContent() {
    val pluginViewModel: com.despegue.tv.ui.screens.plugin.PluginViewModel = hiltViewModel()
...
private fun AccountSettingsInline(
    ...
    val accountViewModel: com.despegue.tv.ui.screens.account.AccountViewModel = hiltViewModel()
    ...
    Column(
        ...
        SettingsGroupCard(modifier = Modifier.fillMaxSize()) {
            com.despegue.tv.ui.screens.account.AccountSettingsContent(

                ...
                Row(
                    ...
                    Switch(
                        ...
                        colors = SwitchDefaults.colors(
                            checkedThumbColor = DespegueColors.Primary,
                            checkedTrackColor = DespegueColors.Primary.copy(alpha = 0.5f)
                        )
                    )
                }
            }
        ...
        Row(
            ...
            Column(modifier = Modifier.weight(1f)) {
                Text(
                    ...
                    color = if (item.isDisabled) DespegueColors.TextSecondary else DespegueColors.TextPrimary
                )
            ...
            Row(
                ...
                Button(
                    ...
                    colors = ButtonDefaults.colors(
                        containerColor = DespegueColors.BackgroundCard,
                        contentColor = if (item.isDisabled) DespegueColors.Success else DespegueColors.TextSecondary,
                        focusedContainerColor = DespegueColors.FocusBackground,
                        focusedContentColor = if (item.isDisabled) DespegueColors.Success else DespegueColors.Error
                    ),
                    border = ButtonDefaults.border(
                        focusedBorder = Border(
                            border = BorderStroke(2.dp, DespegueColors.FocusRing),

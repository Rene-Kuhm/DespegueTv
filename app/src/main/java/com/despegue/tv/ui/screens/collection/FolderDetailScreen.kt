...
import com.despegue.tv.ui.util.dpadRepeatThrottle
...
import com.despegue.tv.ui.components.CatalogRowSection
import com.despegue.tv.ui.components.ContentCard
...
import com.despegue.tv.ui.components.PosterCardStyle
import com.despegue.tv.ui.screens.home.ClassicHomeContent
import com.despegue.tv.ui.screens.home.ContinueWatchingItem
import com.despegue.tv.ui.screens.home.GridHomeContent
import com.despegue.tv.ui.screens.home.HomeScreenFocusState
import com.despegue.tv.domain.model.MetaPreview
import com.despegue.tv.ui.screens.home.ModernHomeContent
...
fun FolderDetailScreen(
    ...
    if (folder == null) {
        Box(modifier = Modifier.fillMaxSize(), contentAlignment = Alignment.Center) {
            Text("Folder not found", color = DespegueColors.TextSecondary)
        }
        return
    }

    val isItemWatched: (MetaPreview) -> Boolean = remember(uiState.movieWatchedStatus) {
        { item -> uiState.movieWatchedStatus[com.despegue.tv.ui.screens.home.homeItemStatusKey(item.id, item.apiType)] == true }
    }
...
@Composable
private fun FolderHeader(folder: com.despegue.tv.domain.model.CollectionFolder) {
    Row(
        modifier = Modifier
            .fillMaxWidth()
        ...
        if (!folder.coverImageUrl.isNullOrBlank()) {
            ...
            when (folder.tileShape) {
                com.despegue.tv.domain.model.PosterShape.POSTER -> { iconWidth = 32.dp; iconHeight = 48.dp }
                com.despegue.tv.domain.model.PosterShape.LANDSCAPE -> { iconWidth = 64.dp; iconHeight = 36.dp }
                com.despegue.tv.domain.model.PosterShape.SQUARE -> { iconWidth = 48.dp; iconHeight = 48.dp }
            }
            AsyncImage(
...
private fun TabbedGridContent(
    ...
    folder: com.despegue.tv.domain.model.CollectionFolder,
                    ...
                    tab.error != null -> {
                        Column(modifier = Modifier.fillMaxWidth()) {
                            ...
                            Box(
                                ...
                                Text(text = tab.error, color = DespegueColors.TextSecondary)
                            }
                        }
                    }
                    tab.catalogRow != null -> {
...
private fun FollowLayoutContent(
    ...
    val isItemWatched: (MetaPreview) -> Boolean = remember(homeState.movieWatchedStatus) {
        { item -> homeState.movieWatchedStatus[com.despegue.tv.ui.screens.home.homeItemStatusKey(item.id, item.apiType)] == true }
    }
    val loadMoreLabel = stringResource(R.string.action_load_more)

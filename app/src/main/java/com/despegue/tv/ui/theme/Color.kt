...
/**
 * Legacy DespegueColors object for backwards compatibility.
 * Components should migrate to using DespegueTheme.colors instead.
 * This object provides the current theme's colors via composition local.
 */
object DespegueColors {
    // Dynamic background colors - Theme dependent with subtle tinting
    val Background: Color
        @Composable
        @ReadOnlyComposable
        get() = DespegueTheme.colors.Background

    val BackgroundElevated: Color
        @Composable
        @ReadOnlyComposable
        get() = DespegueTheme.colors.BackgroundElevated

    val BackgroundCard: Color
        @Composable
        @ReadOnlyComposable
        get() = DespegueTheme.colors.BackgroundCard

    val Surface: Color
        @Composable
        @ReadOnlyComposable
        get() = DespegueTheme.colors.Surface

    val SurfaceVariant: Color
        @Composable
        @ReadOnlyComposable
        get() = DespegueTheme.colors.SurfaceVariant
    ...
    val Secondary: Color
        @Composable
        @ReadOnlyComposable
        get() = DespegueTheme.colors.Secondary

    val SecondaryVariant: Color
        @Composable
        @ReadOnlyComposable
        get() = DespegueTheme.colors.SecondaryVariant

    val OnSecondary: Color
        @Composable
        @ReadOnlyComposable
        get() = DespegueTheme.colors.OnSecondary

    val OnSecondaryVariant: Color
        @Composable
        @ReadOnlyComposable
        get() = DespegueTheme.colors.OnSecondaryVariant

    val FocusRing: Color
        @Composable
        @ReadOnlyComposable
        get() = DespegueTheme.colors.FocusRing

    val FocusBackground: Color
        @Composable
        @ReadOnlyComposable
        get() = DespegueTheme.colors.FocusBackground

    val BorderFocused: Color
        @Composable
        @ReadOnlyComposable
        get() = DespegueTheme.colors.BorderFocused
}

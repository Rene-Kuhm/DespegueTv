        ...
        Row(
            ...
            Image(
                ...
                modifier = Modifier
                    ...
                    .width(47.dp)
                    .height(20.dp),
                colorFilter = ColorFilter.tint(DespegueColors.TextPrimary)
            )
            Text(
...
private fun CommentModeButton(
    ...
    Button(
        ...
        colors = ButtonDefaults.colors(
            containerColor = if (selected) DespegueColors.Secondary else DespegueColors.BackgroundCard,
            contentColor = if (selected) DespegueColors.OnSecondary else DespegueColors.TextPrimary
        )
    ) {
        Text(text)
    }
...
private fun CommentChip(text: String) {
    ...
    Box(
        modifier = Modifier
            .background(
                color = DespegueColors.BackgroundElevated,
                shape = shape
            )
                    ...
                    Button(
                        ...
                        colors = ButtonDefaults.colors(
                            containerColor = if (episode.id == selectedEpisodeId) {
                                DespegueColors.FocusBackground
                            } else {
                                DespegueColors.BackgroundCard
                            },
                            contentColor = DespegueColors.TextPrimary
    ...
    Column(
        ...
        Box(
            modifier = Modifier
                .width(160.dp)
                .height(18.dp)
                .background(DespegueColors.BackgroundElevated, shape = shape)
        )
        Row(horizontalArrangement = Arrangement.spacedBy(8.dp)) {
            repeat(3) {
                Box(

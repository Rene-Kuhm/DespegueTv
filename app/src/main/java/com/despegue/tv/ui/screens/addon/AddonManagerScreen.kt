...
fun AddonManagerScreen(
    ...
    val manageFromPhoneSubtitle = if (webConfigMode == com.despegue.tv.core.server.AddonWebConfigMode.COLLECTIONS_ONLY) {
    ...
    val qrInstruction = if (webConfigMode == com.despegue.tv.core.server.AddonWebConfigMode.COLLECTIONS_ONLY) {

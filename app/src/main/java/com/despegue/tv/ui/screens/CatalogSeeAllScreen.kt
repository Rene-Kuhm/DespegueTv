...
package com.despegue.tv.ui.screens
...
import com.despegue.tv.ui.screens.home.HomeEvent
import com.despegue.tv.ui.screens.home.HomeViewModel
import com.despegue.tv.ui.screens.search.SearchEvent
import com.despegue.tv.ui.screens.search.SearchViewModel
...
fun CatalogSeeAllScreen(
    ...
    posterOptionsViewModel: com.despegue.tv.ui.components.posteroptions.PosterOptionsViewModel = hiltViewModel(),
                    ...
                    itemsIndexed(
                        ...
                        val isWatched = if (isSearchMode) {
                            ...
                            uiState.movieWatchedStatus[
                                com.despegue.tv.ui.screens.home.homeItemStatusKey(item.id, item.apiType)
                            ] == true
                        }
                        GridContentCard(
                            item = item,

...
import com.despegue.tv.data.repository.extractYear
import com.despegue.tv.data.repository.parseContentIds
import com.despegue.tv.data.repository.toTraktIds
        ...
        PlayerEvent.OnRetry -> {
            ...
            if (isTorrentStream && currentInfoHash != null) {
                ...
                launchTorrentSourceStream(
                    stream = com.despegue.tv.domain.model.Stream(
...
internal fun PlayerRuntimeController.buildStreamInfoData(): StreamInfoData {
    ...
    return StreamInfoData(
        ...
        playerEngine = when (currentInternalPlayerEngine) {
            com.despegue.tv.data.local.InternalPlayerEngine.EXOPLAYER -> context.getString(R.string.playback_engine_exoplayer)
            com.despegue.tv.data.local.InternalPlayerEngine.MVP_PLAYER -> context.getString(R.string.playback_engine_mvplayer)
            com.despegue.tv.data.local.InternalPlayerEngine.AUTO -> null
        }
    )
}

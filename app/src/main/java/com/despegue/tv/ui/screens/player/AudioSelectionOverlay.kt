...
import com.despegue.tv.ui.util.languageCodeToName
...
private fun AudioTrackCard(
    ...
    Card(
        ...
        colors = CardDefaults.colors(
            containerColor = if (isSelected) DespegueColors.Secondary else Color.Transparent,
            focusedContainerColor = if (isSelected) DespegueColors.Secondary else Color.Transparent
        ),
        ...
        val primaryTextColor = if (isSelected) DespegueColors.OnSecondary else Color.White
        val secondaryTextColor = if (isSelected) {
            DespegueColors.OnSecondary.copy(alpha = 0.82f)
        } else {
    ...
    Column(
        ...
        Column(
            ...
            Card(
                ...
                colors = CardDefaults.colors(
                    containerColor = if (persistAmplification) DespegueColors.Secondary else Color.Transparent,
                    focusedContainerColor = if (persistAmplification) DespegueColors.Secondary else Color.Transparent
                ),
                shape = CardDefaults.shape(RoundedCornerShape(12.dp)),
                border = CardDefaults.border(
                    border = Border(
                ...
                Text(
                    ...
                    color = if (persistAmplification) DespegueColors.OnSecondary else Color.White,
...
private fun StepCard(
    ...
    Card(
        ...
        border = CardDefaults.border(
            ...
            focusedBorder = Border(
                border = BorderStroke(2.dp, if (enabled) DespegueColors.FocusRing else Color.Transparent),
                shape = RoundedCornerShape(12.dp)
            )
        ),
        scale = CardDefaults.scale(focusedScale = 1f, pressedScale = 1f)

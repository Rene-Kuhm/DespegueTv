...
import com.despegue.tv.data.remote.dto.mdblist.MDBListRatingRequestDto
import com.despegue.tv.domain.model.MDBListRatings
import com.despegue.tv.domain.model.MDBListRatingsResult
        ...
        val imdbId = resolveImdbId(
            meta = Meta(
                ...
                type = when (normalizeMediaType(itemType)) {
                    "show" -> com.despegue.tv.domain.model.ContentType.SERIES
                    else -> com.despegue.tv.domain.model.ContentType.MOVIE
                },
                name = itemId,
                poster = null,
